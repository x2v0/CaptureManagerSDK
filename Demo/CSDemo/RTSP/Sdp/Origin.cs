...
namespace Rtsp.Sdp
{
   ...
   public class Origin
   {
      ...
      /// </summary>
      /// <remarks>
      ///    It is a numeric string such that the tuple of <see cref="Username" />,
      ///    <see cref="SessionId" />, <see cref="NetType" />, <see cref="AddressType" />, and <see cref="UnicastAddress" />
      ///    forms a
      ...
      /// </summary>
      /// <remarks>
      ///    It is the user's login on the originating host, or it is "-"
      ...
      {
         return string.Join(" ", Username, SessionId, SessionVersion.ToString(CultureInfo.InvariantCulture), NetType, AddressType, UnicastAddress);
      }
