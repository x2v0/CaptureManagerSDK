...
namespace WPFWebViewerEVRHandler.Interop
{
   ...
   internal static class ComInterface
   {
      ...
      public delegate int CreateDevice(IDirect3D9 d3D9,
                                       uint Adapter,
                                       int DeviceType,
                                       IntPtr hFocusWindow,
                                       int BehaviorFlags,
      ...
      [UnmanagedFunctionPointer(CallingConvention.StdCall)]
      public delegate int CreateDevice_Ex(IDirect3D9Ex d3D9,
                                          uint Adapter,
                                          int DeviceType,
                                          IntPtr hFocusWindow,
                                          int BehaviorFlags,
      ...
      [UnmanagedFunctionPointer(CallingConvention.StdCall)]
      public delegate int CreateDeviceEx(IDirect3D9Ex d3D9,
                                         uint Adapter,
                                         int DeviceType,
                                         IntPtr hFocusWindow,
                                         int BehaviorFlags,
      ...
      [UnmanagedFunctionPointer(CallingConvention.StdCall)]
      public delegate int CreateRenderTarget(IDirect3DDevice9 device,
                                             uint Width,
                                             uint Height,
                                             int Format,
                                             int MultiSample,
      ...
      [UnmanagedFunctionPointer(CallingConvention.StdCall)]
      public delegate int CreateRenderTargetEx(IDirect3DDevice9Ex device,
                                               uint Width,
                                               uint Height,
                                               int Format,
                                               int MultiSample,
