...
namespace CaptureManager
{
   namespace MediaSession
   {
      ...
      {
         MIDL_INTERFACE("D9AAE580-0D95-4061-B721-B91959295D6E") IPresentationClock : public IUnknown
         {
            virtual HRESULT addIMediaPipelineProcessorControl(
               IMediaPipelineProcessorControl* aPtrIMediaPipelineProcessorControl) = 0;
