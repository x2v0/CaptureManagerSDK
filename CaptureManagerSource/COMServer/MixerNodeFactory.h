...
namespace CaptureManager
{
   namespace COMServer
   {
      class MixerNodeFactory : public BaseDispatch<IMixerNodeFactory>
      {
      public:
         MixerNodeFactory();
         ...
         STDMETHOD(createMixerNodes)(/* [in] */ IUnknown* aPtrDownStreamTopologyNode, /* [in] */ DWORD aInputNodeAmount,
                                                /* [out] */ VARIANT* aPtrArrayPtrTopologyInputNodes) override;
