...
namespace CaptureManager
{
   namespace COMServer
   {
      class SwitcherNodeFactory : public BaseDispatch<ISwitcherNodeFactory>
      {
      public:
         SwitcherNodeFactory();

         virtual ~SwitcherNodeFactory(); // ISwitcherNodeFactory interface
         STDMETHOD(createSwitcherNode)(IUnknown* aPtrDownStreamTopologyNode, IUnknown** aPtrPtrTopologySwitcherNode)
