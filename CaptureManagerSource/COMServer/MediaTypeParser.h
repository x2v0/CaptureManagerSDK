...
namespace CaptureManager
{
   namespace COMServer
   {
      class MediaTypeParser : public BaseDispatch<IMediaTypeParser>
      {
      public:
         STDMETHOD(parse)(IUnknown* aPtrMediaType, BSTR* aPtrPtrXMLstring) override; // IDispatch interface stub
