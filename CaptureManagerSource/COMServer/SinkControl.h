...
namespace CaptureManager
{
   namespace COMServer
   {
      class SinkControl : public BaseDispatch<ISinkControl>
      {
      public: // ISinkControl interface
         STDMETHOD(getCollectionOfSinks)(/* [out][in] */ BSTR* aPtrPtrXMLstring) override;

         STDMETHOD(createSinkFactory)(REFGUID aRefContainerTypeGUID, REFIID aREFIID, IUnknown** aPtrPtrSink) override;
