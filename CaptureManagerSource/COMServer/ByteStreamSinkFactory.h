...
namespace CaptureManager
{
   namespace COMServer
   {
      class ByteStreamSinkFactory : public BaseUnknown<IByteStreamSinkFactory, IContainer>
      {
      public:
         static GUIDToNamePair getGUIDToNamePair(); // IFileSinkFactory interface
         STDMETHOD(createOutputNodes)(VARIANT aArrayPtrCompressedMediaTypes, IUnknown* aPtrByteStreamActivate,
         ...
         virtual HRESULT invokeMethod( /* [annotation][in] */ _In_ DISPID dispIdMember,
                                                              /* [annotation][out][in] */
                                                              _In_ DISPPARAMS* pDispParams,   /* [annotation][out] */
                                                              _Out_opt_ VARIANT* pVarResult); // IContainer interface
