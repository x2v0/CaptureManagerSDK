...
namespace CaptureManager
{
   namespace COMServer
   {
      class CoCaptureManager : public BaseDispatch<ICaptureManagerControl>
      {
      public:
         CoCaptureManager();

         virtual ~CoCaptureManager(); // ICaptureManagerControl interface
         STDMETHOD(createControl)(REFIID aREFIID, IUnknown** aPtrPtrControl) override;

         STDMETHOD(createMisc)(REFIID aREFIID, IUnknown** aPtrPtrMisc) override;     // IDispatch interface stub
