...
#define DeviceType_Audio	2
      typedef std::unordered_map<DWORD, CComPtrCustom<IMFMediaType>> StreamMediaType;

      class InitilaizeCaptureSource : public BaseUnknown<IInitilaizeCaptureSource>
      {
      ...
      public:
         ...
         HRESULT processVideoMediaType(pugi::xml_node& aMediaType, IMFMediaType* aPtrVideoMediaType);

         HRESULT processAudioMediaType(pugi::xml_node& aMediaType, IMFMediaType* aPtrAudioMediaType);

         HRESULT processStreamDescriptor(pugi::xml_node& aStreamDescriptor, StreamMediaType& aStreamMediaType);

         //    IInitilaizeCaptureSource methods
         HRESULT STDMETHODCALLTYPE setPresentationDescriptor(/* [in] */ BSTR aXMLPresentationDescriptor) override;
