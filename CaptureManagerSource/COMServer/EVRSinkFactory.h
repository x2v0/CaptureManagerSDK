...
namespace CaptureManager
{
   namespace COMServer
   {
      class EVRSinkFactory : public BaseDispatch<IEVRSinkFactory, IContainer>
      {
      public:
         static GUIDToNamePair getGUIDToNamePair();

         // IEVRSinkFactory interface
         STDMETHOD(createOutputNode)(LPVOID aHWND, IUnknown** aPtrPtrTopologyNode) override; // IDispatch interface stub
