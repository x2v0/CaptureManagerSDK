...
namespace CaptureManager
{
   namespace COMServer
   {
      class SessionControl : public BaseDispatch<ISessionControl>
      {
      public: // ISessionControl interface
         STDMETHOD(createSession)(VARIANT aArrayPtrSourceNodesOfTopology, REFIID aREFIID, IUnknown** aPtrPtrSession)
