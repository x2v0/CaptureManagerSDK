...
namespace CaptureManager
{
   namespace Transform
   {
      ...
      {
         class VideoSampleAllocatorTransform : public BaseUnknown<IMFTransform>
         {
         public:
            VideoSampleAllocatorTransform();

            virtual ~VideoSampleAllocatorTransform(); // IMFTransform interface
            ...
            HRESULT init(IMFVideoSampleAllocator* aPtrIMFVideoSampleAllocator, IMFMediaType* aPtrMediaType);
