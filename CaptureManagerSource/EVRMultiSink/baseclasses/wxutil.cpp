...
BOOL CAMMsgEvent::WaitMsg(DWORD dwTimeout)
{
    ...
    if (dwWaitTime != INFINITE) {
		dwStartTime = CaptureManager::Core::Winmm::WinmmManager::timeGetTime();
    }
    ...
    do {
	    ...
	    if (dwWaitTime != INFINITE) {
			...
			DWORD dwElapsed = CaptureManager::Core::Winmm::WinmmManager::timeGetTime() - dwStartTime;
...
MMRESULT CompatibleTimeSetEvent( UINT uDelay, UINT uResolution, __in LPTIMECALLBACK lpTimeProc, DWORD_PTR dwUser, UINT fuEvent )
{
	...
	return CaptureManager::Core::Winmm::WinmmManager::timeSetEvent(uDelay, uResolution, lpTimeProc, dwUser, fuEvent);
}
