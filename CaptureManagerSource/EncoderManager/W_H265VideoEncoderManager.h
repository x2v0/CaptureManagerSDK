...
namespace CaptureManager
{
   namespace Transform
   {
      namespace Encoder
      {
         class W_H265VideoEncoderManager : public BaseUnknown<IEncoderManager>, public BaseEncoderManager
         {
         public:
            W_H265VideoEncoderManager(); // IEncoderManager interface
            ...
            HRESULT getEncoder(IMFMediaType* aPtrUncompressedMediaType, EncodingSettings aEncodingSettings,
                               REFGUID aRefEncoderCLSID, DWORD lIndexCompressedMediaType,
                               IMFTransform** aPtrPtrEncoderTransform) override; // W_H265VideoEncoderManager interface
