...
namespace CaptureManager
{
   namespace Core
   {
      namespace Winmm
      {
         typedef MMRESULT (WINAPI* timeKillEvent)(UINT);

         typedef DWORD (WINAPI *timeGetTime)();

         typedef MMRESULT (WINAPI* timeBeginPeriod)(UINT);

         typedef MMRESULT (WINAPI* timeEndPeriod)(UINT);

         typedef MMRESULT (WINAPI* timeSetEvent)(UINT, UINT, LPTIMECALLBACK, DWORD_PTR, UINT);

         typedef MMRESULT (WINAPI* timeGetDevCaps)(LPTIMECAPS ptc, UINT cbtc);
         ...
         public:
            ...
            static MMRESULT WINAPI stubtimeKillEvent(UINT)
            {
               return E_NOTIMPL;
            }
            ...
            static MMRESULT WINAPI stubtimeBeginPeriod(UINT)
            {
               return E_NOTIMPL;
            }

            static MMRESULT WINAPI stubtimeEndPeriod(UINT)
            {
               return E_NOTIMPL;
            }

            static MMRESULT WINAPI stubtimeSetEvent(UINT, UINT, LPTIMECALLBACK, DWORD_PTR, UINT)
            {
               return E_NOTIMPL;
            }

            static MMRESULT WINAPI stubtimeGetDevCaps(LPTIMECAPS ptc, UINT cbtc)
            {
               return E_NOTIMPL;
            }
