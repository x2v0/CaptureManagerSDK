...
#define LOG_INVOKE_DX9EX_METHOD(Function, Object, ...) lresult = Object->Function(__VA_ARGS__);\
	if (FAILED(lresult))break;\
...
#endif
         typedef HRESULT (STDAPICALLTYPE *Direct3DCreate9Ex)(UINT, IDirect3D9Ex**);
         ...
         public:
            ...
            static HRESULT CreateDeviceEx(IDirect3D9Ex* aPtrIDirect3D9Ex, UINT Adapter, D3DDEVTYPE DeviceType,
         ...
         private:
            ...
            static HRESULT STDAPICALLTYPE stubDirect3DCreate9Ex(UINT, IDirect3D9Ex**)
            {
               return E_NOTIMPL;
            }
            ...
            Direct3D9ExManager(const Direct3D9ExManager&) = delete;

            Direct3D9ExManager& operator=(const Direct3D9ExManager&) = delete;
         };
      }
   }
}
