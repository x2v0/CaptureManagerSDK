...
#define LOG_INVOKE_DX11_METHOD(Function, Object, ...) lresult = Object->Function(__VA_ARGS__);\
	if (FAILED(lresult))break;
#endif
         typedef HRESULT (WINAPI *D3D11CreateDevice)(IDXGIAdapter*, D3D_DRIVER_TYPE, HMODULE, UINT, D3D_FEATURE_LEVEL*,
         ...
         private:
            ...
            static HRESULT WINAPI stubD3D11CreateDevice(IDXGIAdapter* aPtrAdapter, D3D_DRIVER_TYPE aDriverType,
                                                        HMODULE aSoftware, UINT aFlags,
                                                        D3D_FEATURE_LEVEL* aPtrFeatureLevels, UINT aFeatureLevels,
                                                        UINT aSDKVersion, ID3D11Device** aPtrPtrDevice,
