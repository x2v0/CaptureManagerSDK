...
namespace CaptureManager
{
   namespace Sources
   {
      ...
      MIDL_INTERFACE("4A4D8347-FDB3-4A8E-A45F-4AEC9D2F68CF") ISourceOperation : public IUnknown
      {
      public:
         virtual HRESULT getObject(IUnknown** aPtrPtrObject) = 0;

         virtual HRESULT getSourceOperationType(SourceOperationType* aPtrSourceOperationType) = 0;

         virtual HRESULT getStreamIdentifier(DWORD* aPtrStreamIdentifier) = 0;
      };
   }
}
