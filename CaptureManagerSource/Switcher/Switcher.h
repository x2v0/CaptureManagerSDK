...
namespace CaptureManager
{
   namespace Transform
   {
      class Switcher : public BaseUnknown<IMFTransform, ISwitcher>
      {
      public:
         Switcher();
         ...
         STDMETHODIMP ProcessOutput(DWORD aFlags, DWORD aOutputBufferCount, MFT_OUTPUT_DATA_BUFFER* aPtrOutputSamples,
                                    DWORD* aPtrStatus) override; // ISwitcher interface
