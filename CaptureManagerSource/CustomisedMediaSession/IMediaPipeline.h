...
namespace CaptureManager
{
   namespace MediaSession
   {
      ...
      {
         MIDL_INTERFACE("971B67BA-1AB4-4091-9505-92B90F6768D0") IMediaPipeline : public IMFAsyncCallback
         {
         public:
            IMediaPipeline() { }
            virtual ~IMediaPipeline() { }

            virtual HRESULT startSources(const GUID* aConstPtrGUIDTimeFormat,
