...
namespace CaptureManager
{
   namespace MediaSession
   {
      ...
      {
         MIDL_INTERFACE("DADB2F8F-48A5-4A33-AFC3-FEF96CEE317D") ISessionSwitcherControl : public IUnknown
         {
            ...
            virtual HRESULT STDMETHODCALLTYPE attachSwitcher(/* [in] */ IMFTopologyNode* aPtrSwitcherNode, /* [in] */
