...
namespace CaptureManager
{
   namespace Sources
   {
      ...
      {
         MIDL_INTERFACE("CF999140-05FD-48CB-9C57-1BA973B8E66F") IInnerScreenCaptureProcessor : public IUnknown
         {
            virtual HRESULT getSize(SIZE& aRefSize) = 0;

            virtual HRESULT releaseResources() = 0;

            virtual HRESULT initResources(IUnknown* aPtrUnkDevice, ID3D11DeviceContext* aPtrDeviceContext,
                                          UINT aVideoFrameDuration, int aStride) = 0;
